...
$(document).ready(function () {
    ...
    // Handles Hospital selection change to reload Departments dropdown
    ...
    // Handles Department selection change to reload Doctors list
    ...
    if ($('#step-2-form').length) {
        ...
        // Dynamic doctors list loader per hospital selection
            ...
            if (hospitalId) {
                ...
                try {
                    ...
                    if (doctors && doctors.length > 0) {
                        ...
                        // Pre-select doctor if parameter exists in query string
        ...
        $('#step-2-form').submit(function (e) {
            ...
            $('#rev-department').text($('#step-2-form select[name="department"] option:selected').text());
