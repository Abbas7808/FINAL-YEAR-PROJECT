...
/**
 * ==========================================================================
 * MED NOVA - BACKEND LAYOUT HEADER (header.php)
 * ==========================================================================
 * This layout template forms the global visual frame for the admin panels
 * (System Admin and Hospital Admin). It renders the HTML boilerplate, 
 * CSS/JS inclusions, the sidebar shell, and the top navigation bar.
 * 
 * Flow details:
 * 1. Head imports (Bootstrap 5, FontAwesome, custom style.css).
 * 2. Sidebar inclusion (dynamically adapts links based on current role).
 * 3. Notification system (pre-sorts active alerts into read/unread).
 * 4. Adaptive global search (targets Admin search vs Hospital Admin search).
 * 5. Current Session profile pill (computed dynamic initials, dropdown controls).
 */
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <!-- Dynamic Title tag injection based on controller parameters -->
    <title><?= isset($page_title) ? htmlspecialchars($page_title) . ' — Mid-Nova' : 'Mid-Nova Admin' ?></title>
    
    <!-- Third-Party Style Integrations & Global Theme Stylesheet -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="assets/css/style.css?v=1780419041">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
    <script src="assets/js/theme.js?v=1780419041"></script>
</head>
<body>
    <div class="dashboard-container">
        <!-- Render Side Menu (Links are dynamically adjusted to fit system vs hospital admin actions) -->
        ...
        <div class="main-content">
            ...
            <?php
                // Extract notifications list passed from the calling controller
                $notifs  = $notifications ?? [];
                $unread  = [];
                $read    = [];
                
                // Segment notifications into Read vs Unread categories
                foreach ($notifs as $n) {
                    // System checks 'is_read' field. Blood requests have no distinct ID and are default marked read.
                    $isRead = isset($n['id']) ? (($n['is_read'] ?? 0) == 1) : true; 
                    if (!$isRead) {
                        $unread[] = $n;
                    } else {
                        $read[] = $n;
            ...
            <div class="top-header">
                ...
                <button class="btn btn-link text-reset d-md-none me-3" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarCollapse" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <!-- Universal Search Bar (Adapts route target depending on logged-in role) -->
                ...
                <div class="header-actions">
                    ...
                    <div class="dropdown">
                        <button class="icon-btn position-relative" id="notifBtn"
                            ...
                            <!-- Alert badge indicating unread notifications count -->
                        ...
                        <div class="dropdown-menu dropdown-menu-end shadow border-0 rounded-4 p-0"
                            ...
                            <!-- Sticky Alert Panel Header -->
                            <div class="px-4 py-3 border-bottom d-flex align-items-center justify-content-between"
                                 style="position:sticky;top:0;background:var(--bg-card);z-index:1;">
                            ...
                            ?>
                                ...
                                <a href="<?= $href ?>" class="text-decoration-none">
                                    <div class="notif-item d-flex align-items-start gap-3 px-4 py-3 border-bottom <?= $isUnread ? '' : 'opacity-75' ?>">
                                        ...
                                        <div style="flex:1;min-width:0;">
                                            <div class="small <?= $isUnread ? 'fw-semibold' : 'fw-normal' ?> text-reset" style="line-height:1.3;"><?= htmlspecialchars($n['message']) ?></div>
                                            <div class="text-muted" style="font-size:11px;"><?= date('M d, g:i a', strtotime($n['time'])) ?></div>
                                        </div>
                                        <?php if ($isUnread): ?>
                                            <!-- Colored dot highlight for unread status -->
                                ...
                                <!-- View All Alert Log Redirect Link -->
                    ...
                    <div class="dropdown">
                        <button class="user-pill" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <!-- Extract first letter of name to build initials avatar -->
            ...
            <!-- Main view container body starts here -->
