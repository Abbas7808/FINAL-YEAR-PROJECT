...
<body onload="window.print()">
    <div class="header" style="font-size: 22px; margin-bottom: 5px; text-transform: uppercase;">
        <?= !empty($token['hospital_name']) ? htmlspecialchars($token['hospital_name']) : 'Med Nova Hospital' ?>
    </div>
    <div style="font-size: 14px; color: #555; margin-bottom: 10px;">Outpatient Department</div>
